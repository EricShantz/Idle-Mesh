  ...
  return (
    <>
      <button
        ...
        className="fixed top-3 left-3 px-3 h-9 rounded-full border border-gray-600 bg-gray-800/90 hover:bg-gray-700 text-gray-300 hover:text-white flex items-center justify-center text-base font-semibold backdrop-blur-sm transition-colors"
        style={{ zIndex: 50 }}
        title="Help & Info"
      >
        Guide
